...
$GXX -std=c++17 $CXXFLAGS -c ${SRC_DIR}/task.cpp -o ${BUILD_DIR}/task.o
...
$GXX ${BUILD_DIR}/cudafunctions.o ${BUILD_DIR}/mesh.o ${BUILD_DIR}/dtensor.o ${BUILD_DIR}/task.o ${BUILD_DIR}/test_dtensor.o $LIBS -o ${BUILD_DIR}/test_dtensor
